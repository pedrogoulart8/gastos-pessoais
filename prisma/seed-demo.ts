...
// Abril 2026 (mês corrente) + Março 2026 (pra alimentar MonthlyComparisonCards)
...
async function main() {
  console.log("Limpando transações e comprovantes existentes...");
  ...
  console.log(`Criando ${transactions.length} transações demo...`);
  let created = 0;
